...
var idToPokemon = {};
var DEFAULT_EXCLUDE = [ 13, 10, 16, 19, 21, 41, 48 ];
...
$.getJSON("static/locales/pokemon." + document.documentElement.lang + ".json").done(function(data) {
    ...
    if (localStorage['remember_select_exclude']) {
        ...
        $selectExclude.val(DEFAULT_EXCLUDE).trigger('change');
    }
...
var excludedPokemon = ["Rattata","Pidgey","Zubat","Caterpie","Weedle","Spearow"];
var notifiedPokemon = [];
